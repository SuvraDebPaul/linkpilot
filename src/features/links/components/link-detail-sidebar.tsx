...
export function LinkDetailSidebar({
  id,
  title,
  shortCode,
  shortUrl,
  ...
  return (
    <div className="space-y-4">
      ...
      <Card>
        ...
        <CardContent className="flex flex-col items-center gap-3">
          ...
          <div className="flex w-full gap-2">
            <QrDownloadButton dataUrl={qrDataUrl} shortCode={shortCode} />
          </div>
          <Link
      ...
      <Link
        href={`/dashboard/links/${id}/edit`}
        className="flex items-center justify-between rounded-xl border border-dashed border-border bg-muted/20 px-4 py-3 text-sm transition-colors hover:bg-muted/40"
      >
        <span className="flex items-center gap-2 text-foreground">
          <Settings2 className="h-4 w-4 text-muted-foreground" />
          Geo targeting, A/B tests, cloaking &amp; more
        </span>
