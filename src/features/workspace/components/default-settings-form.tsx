...
const SLUG_OPTIONS: {
...
}[] = [
  {
    value: "incremental",
    label: "Incremental",
    sub: "Slugs follow each other in order",
    example: "7",
  },
  {
    value: "random",
    label: "Random",
    sub: "Slugs will contain 6 random characters",
    example: "fipBMz",
  },
  {
    value: "secure",
    label: "Secure",
    sub: "Slugs will contain 12 random characters",
    example: "aZ3kLp9qXrTd",
  },
];
  ...
  [
    {
      value: "301",
      code: "301",
      label: "Permanent — for pages moved permanently",
    },
    ...
    { value: "307", code: "307", label: "Standard — for forms submission" },
    {
      value: "308",
      code: "308",
      label: "Permanent — for forms submission with redirect",
    },
  ];
...
export function DefaultSettingsForm({
  ...
  const [slugStyle, setSlugStyle] = useState<SlugStyle>(
    initialSlugStyle as SlugStyle,
  );
  const [redirectType, setRedirectType] = useState<RedirectType>(
    initialRedirectType as RedirectType,
  );
  ...
  const activeSlugExample =
    SLUG_OPTIONS.find((o) => o.value === slugStyle)?.example ?? "fipBMz";
    ...
    <div className="grid gap-6 lg:grid-cols-3 lg:items-start">
      <Card className="col-span-2">
        <CardHeader>
          ...
          <CardDescription>
            Slug style, redirect behavior, and cloaking for new links.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-8">
          ...
          <div className="flex items-center justify-between gap-4 rounded-lg border border-border px-3 py-2.5">
            <div>
              <p className="text-sm font-medium text-foreground">
                Cloaking enabled by default
              </p>
              <p className="text-xs text-muted-foreground">
                Hide the destination URL behind the short link for new links.
              </p>
            </div>
      ...
      <div className="space-y-6 lg:sticky lg:top-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              What a new link will look like with these defaults.
            </CardDescription>
          </CardHeader>
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Starting color and error correction for every new link&apos;s QR code.
          Doesn&apos;t affect existing links.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
