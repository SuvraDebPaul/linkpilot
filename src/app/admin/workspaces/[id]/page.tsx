    ...
    <div className="max-w-3xl">
      ...
      <div className="mt-6 grid grid-cols-2 gap-4 rounded-xl border border-border bg-card p-4 text-sm sm:grid-cols-4">
        <div>
          ...
          <p className="mt-1 text-foreground">{workspace.createdAt.toLocaleDateString()}</p>
        </div>
        <div>
          <p className="text-xs text-muted-foreground">Links</p>
          <p className="mt-1 text-foreground">{workspace._count.links}</p>
        </div>
        <div>
          <p className="text-xs text-muted-foreground">Campaigns</p>
          <p className="mt-1 text-foreground">{workspace._count.campaigns}</p>
        </div>
        <div>
          <p className="text-xs text-muted-foreground">Custom domains</p>
          <p className="mt-1 text-foreground">{workspace._count.customDomains}</p>
        </div>
      </div>
