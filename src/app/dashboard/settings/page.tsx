      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <ProfileForm name={user.name} email={user.email!} image={user.image} emailVerified={!!user.emailVerified} />
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              {hasPassword ? "Change your login password." : "Set a password to enable email/password sign-in."}
            </CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="flex items-center justify-between gap-4 border-t border-border pt-5">
            <div>
              ...
              <p className="mt-0.5 text-xs text-muted-foreground">
                Sign out of this device and every other device you&apos;re logged into.
              </p>
            </div>
          ...
          <div className="border-t border-border pt-5">
            <p className="mb-3 text-sm font-medium text-foreground">Recent login activity</p>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <Card className="lg:col-span-2">
          <CardHeader>
            ...
            <CardDescription>Choose how LinkPilot looks on this device.</CardDescription>
          </CardHeader>
          <CardContent>
            <ThemeSwitcher />
          </CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>A summary of your account&apos;s activity, sent once a month.</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="flex items-center justify-between gap-4">
              <p className="text-sm font-medium text-foreground">Receive by email</p>
