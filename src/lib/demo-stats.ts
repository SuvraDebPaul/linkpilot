...
export function getDemoLinks() {
  return [
    // ── Active, high-traffic ──────────────────────────────────────────────────
    {
      ...
      shortCode: "summer24",
      originalUrl: "https://mystore.com/summer-sale-2024",
      isActive: true,
    ...
    {
      id: "dl-02",
      title: "Google Ads — Brand Campaign",
      shortCode: "gads-br",
      originalUrl: "https://mystore.com/lp/brand?utm_source=google",
      isActive: true,
      isPasswordProtected: false,
      isFavorite: false,
      expiresAt: null,
    ...
    {
      id: "dl-03",
      title: "Email Signature Link",
      shortCode: "email-sig",
      originalUrl: "https://mystore.com?ref=email-signature",
      isActive: true,
      isPasswordProtected: false,
      isFavorite: false,
      expiresAt: null,
    ...
    {
      id: "dl-04",
      title: "App Store Download — iOS",
      shortCode: "app-ios",
      originalUrl: "https://apps.apple.com/app/mystore/id123456789",
      isActive: true,
      isPasswordProtected: false,
      isFavorite: true,
      expiresAt: null,
    ...
    {
      id: "dl-05",
      title: "Affiliate Partner — TechBlog",
      shortCode: "aff-tb",
      originalUrl: "https://mystore.com?aff=techblog&sub=review",
      isActive: true,
      isPasswordProtected: false,
      isFavorite: false,
      expiresAt: null,
    ...
    {
      id: "dl-06",
      title: "YouTube Description CTA",
      shortCode: "yt-desc",
      originalUrl: "https://mystore.com/shop?ref=youtube",
      isActive: true,
      isPasswordProtected: false,
      isFavorite: false,
      expiresAt: null,
    ...
    },
    {
      ...
      shortCode: "tw-bio",
      originalUrl: "https://mystore.com?ref=twitter",
      isActive: true,
      isPasswordProtected: false,
      isFavorite: false,
      expiresAt: null,
    ...
    },
    {
      ...
      shortCode: "gads-retg",
      originalUrl: "https://mystore.com/lp/retarget?utm_source=google",
      isActive: true,
      isPasswordProtected: false,
      isFavorite: false,
      expiresAt: null,
    ...
    },
    {
      ...
      shortCode: "li-post",
      originalUrl: "https://mystore.com/blog/case-study?ref=linkedin",
      isActive: true,
      isPasswordProtected: false,
      isFavorite: false,
      expiresAt: null,
    ...
    {
      id: "dl-10",
      title: "Play Store Download — Android",
      shortCode: "app-android",
      originalUrl: "https://play.google.com/store/apps/details?id=mystore",
      isActive: true,
      isPasswordProtected: false,
      isFavorite: true,
      expiresAt: null,
    ...
    // ── Active, mid-traffic ───────────────────────────────────────────────────
    {
      ...
      shortCode: "tt-bio",
      originalUrl: "https://mystore.com?ref=tiktok",
      isActive: true,
      isPasswordProtected: false,
      isFavorite: false,
      expiresAt: null,
    ...
    {
      id: "dl-12",
      title: "Facebook Ad — Lookalike Audience",
      shortCode: "fb-look",
      originalUrl: "https://mystore.com/lp/lookalike?utm_source=fb",
      isActive: true,
      isPasswordProtected: false,
      isFavorite: false,
      expiresAt: null,
    ...
    {
      id: "dl-13",
      title: "Newsletter CTA — June Edition",
      shortCode: "nl-jun",
      originalUrl: "https://mystore.com/newsletter-offer?m=jun24",
      isActive: true,
      isPasswordProtected: false,
      isFavorite: false,
      expiresAt: null,
    ...
    {
      id: "dl-14",
      title: "Affiliate Partner — DesignHub",
      shortCode: "aff-dh",
      originalUrl: "https://mystore.com?aff=designhub&sub=article",
      isActive: true,
      isPasswordProtected: false,
      isFavorite: false,
      expiresAt: null,
    ...
    },
    {
      ...
      shortCode: "webinar-q2",
      originalUrl: "https://mystore.com/webinar/q2-2024",
      isActive: true,
      isPasswordProtected: false,
      isFavorite: false,
    ...
    },
    {
      ...
      shortCode: "ig-bio",
      originalUrl: "https://mystore.com?ref=instagram",
      isActive: true,
      isPasswordProtected: false,
      isFavorite: false,
      expiresAt: null,
    ...
    {
      id: "dl-17",
      title: "Podcast Sponsor Code",
      shortCode: "pod-code",
      originalUrl: "https://mystore.com/discount?code=PODCAST20",
      isActive: true,
    ...
    {
      id: "dl-18",
      title: "Pinterest Campaign — Home Decor",
      shortCode: "pin-home",
      originalUrl: "https://mystore.com/category/home-decor?ref=pinterest",
      isActive: true,
      isPasswordProtected: false,
      isFavorite: false,
      expiresAt: null,
    ...
    {
      id: "dl-19",
      title: "Reddit AMA Promo",
      shortCode: "reddit-ama",
      originalUrl: "https://mystore.com/ama-deal?ref=reddit",
      isActive: true,
      isPasswordProtected: false,
      isFavorite: false,
      expiresAt: null,
    ...
    {
      id: "dl-20",
      title: "SMS Campaign — Flash Sale",
      shortCode: "sms-flash",
      originalUrl: "https://mystore.com/flash-sale?utm_source=sms",
      isActive: true,
      isPasswordProtected: false,
      isFavorite: false,
      expiresAt: daysAgo(-3),
    ...
    // ── Active, lower-traffic ─────────────────────────────────────────────────
    {
      ...
      shortCode: "ph-launch",
      originalUrl: "https://mystore.com/launch?ref=producthunt",
      isActive: true,
      isPasswordProtected: false,
      isFavorite: true,
      expiresAt: daysAgo(-6),
    ...
    },
    {
      ...
      shortCode: "vip-ea",
      originalUrl: "https://mystore.com/vip/early-access",
      isActive: true,
      isPasswordProtected: true,
      isFavorite: true,
    ...
    {
      id: "dl-23",
      title: "Snapchat Story Link",
      shortCode: "snap-story",
      originalUrl: "https://mystore.com/new-arrivals?ref=snapchat",
      isActive: true,
      isPasswordProtected: false,
      isFavorite: false,
      expiresAt: null,
    ...
    },
    {
      ...
      shortCode: "blog-seo",
      originalUrl: "https://mystore.com/blog/ultimate-seo-guide",
      isActive: true,
      isPasswordProtected: false,
      isFavorite: false,
      expiresAt: null,
    ...
    {
      id: "dl-25",
      title: "WhatsApp Broadcast Link",
      shortCode: "wa-promo",
      originalUrl: "https://mystore.com/deals?utm_source=whatsapp",
      isActive: true,
      isPasswordProtected: false,
      isFavorite: false,
      expiresAt: null,
      createdAt: daysAgo(8),
      tags: ["messaging", "promo"],
      _count: { clicks: 96 },
    },
    {
      id: "dl-26",
      title: "Referral Program Landing",
      shortCode: "refer",
      originalUrl: "https://mystore.com/referral",
      isActive: true,
      isPasswordProtected: false,
      isFavorite: false,
      expiresAt: null,
    ...
    },
    {
      ...
      shortCode: "cs-ent",
      originalUrl: "https://mystore.com/case-studies/enterprise",
      isActive: true,
      isPasswordProtected: true,
      isFavorite: false,
      expiresAt: null,
    ...
    {
      id: "dl-28",
      title: "Twitch Stream Donation Link",
      shortCode: "twitch-don",
      originalUrl: "https://mystore.com/support?ref=twitch",
      isActive: true,
      isPasswordProtected: false,
      isFavorite: false,
      expiresAt: null,
    ...
    {
      id: "dl-29",
      title: "Newsletter CTA — May Edition",
      shortCode: "nl-may",
      originalUrl: "https://mystore.com/newsletter-offer?m=may24",
      isActive: true,
      isPasswordProtected: false,
      isFavorite: false,
      expiresAt: null,
    ...
    },
    {
      ...
      shortCode: "discord",
      originalUrl: "https://discord.gg/mystore-community",
      isActive: true,
      isPasswordProtected: false,
      isFavorite: false,
      expiresAt: null,
    ...
    {
      id: "dl-31",
      title: "Instagram Bio Link (Old)",
      shortCode: "ig-bio-old",
      originalUrl: "https://mystore.com?ref=ig-old",
      isActive: false,
      isPasswordProtected: false,
      isFavorite: false,
      expiresAt: null,
    ...
    {
      id: "dl-32",
      title: "Facebook Ad — Retargeting",
      shortCode: "fb-retg",
      originalUrl: "https://mystore.com/lp/retarget?utm_source=fb",
      isActive: false,
      isPasswordProtected: false,
      isFavorite: false,
      expiresAt: null,
    ...
    {
      id: "dl-33",
      title: "Old Homepage Redirect",
      shortCode: "home-v1",
      originalUrl: "https://mystore.com/v1",
      isActive: false,
      isPasswordProtected: false,
      isFavorite: false,
      expiresAt: null,
    ...
    {
      id: "dl-34",
      title: "Bing Ads — Product Category",
      shortCode: "bing-cat",
      originalUrl: "https://mystore.com/category/featured?utm_source=bing",
      isActive: false,
      isPasswordProtected: false,
      isFavorite: false,
      expiresAt: null,
    ...
    {
      id: "dl-35",
      title: "Deprecated API Docs Link",
      shortCode: "api-v1",
      originalUrl: "https://docs.mystore.com/v1",
      isActive: false,
      isPasswordProtected: false,
      isFavorite: false,
      expiresAt: null,
    ...
    },
    {
      ...
      shortCode: "pricing-v2",
      originalUrl: "https://mystore.com/pricing-2023",
      isActive: false,
      isPasswordProtected: false,
      isFavorite: false,
      expiresAt: null,
    ...
    {
      id: "dl-37",
      title: "Paused Influencer Campaign",
      shortCode: "inf-pause",
      originalUrl: "https://mystore.com/collab?utm_source=influencer",
      isActive: false,
      isPasswordProtected: false,
      isFavorite: false,
      expiresAt: null,
    ...
    {
      id: "dl-38",
      title: "Black Friday 2023 — Main Promo",
      shortCode: "bfri23",
      originalUrl: "https://mystore.com/black-friday-2023",
      isActive: false,
      isPasswordProtected: false,
      isFavorite: true,
    ...
    },
    {
      ...
      shortCode: "winter23",
      originalUrl: "https://mystore.com/winter-sale-2023",
      isActive: false,
      isPasswordProtected: false,
      isFavorite: false,
    ...
    {
      id: "dl-40",
      title: "Spring Flash Sale — 48 Hours",
      shortCode: "spring-fs",
      originalUrl: "https://mystore.com/spring-flash?utm_source=email",
      isActive: false,
      isPasswordProtected: false,
      isFavorite: false,
    ...
    {
      id: "dl-41",
      title: "Easter Promo 2024",
      shortCode: "easter24",
      originalUrl: "https://mystore.com/easter-2024",
      isActive: false,
      isPasswordProtected: false,
      isFavorite: false,
    ...
    },
    {
      ...
      shortCode: "val24",
      originalUrl: "https://mystore.com/valentines-2024",
      isActive: false,
      isPasswordProtected: false,
      isFavorite: false,
    ...
    },
    {
      ...
      shortCode: "ny24-sale",
      originalUrl: "https://mystore.com/new-year-2024",
      isActive: false,
      isPasswordProtected: false,
      isFavorite: false,
    ...
    },
    {
      ...
      shortCode: "cyber23",
      originalUrl: "https://mystore.com/cyber-monday-2023",
      isActive: false,
      isPasswordProtected: false,
      isFavorite: false,
      expiresAt: daysAgo(185),
    ...
    {
      id: "dl-45",
      title: "Threads Profile Link",
      shortCode: "threads",
      originalUrl: "https://mystore.com?ref=threads",
      isActive: true,
      isPasswordProtected: false,
      isFavorite: false,
      expiresAt: null,
    ...
    {
      id: "dl-46",
      title: "Q3 Report Download",
      shortCode: "q3-report",
      originalUrl: "https://mystore.com/reports/q3-2024.pdf",
      isActive: true,
      isPasswordProtected: true,
      isFavorite: false,
      expiresAt: null,
    ...
    },
    {
      ...
      shortCode: "feat-jul",
      originalUrl: "https://mystore.com/blog/new-features-july-2024",
      isActive: true,
      isPasswordProtected: false,
      isFavorite: false,
      expiresAt: null,
    ...
    {
      id: "dl-48",
      title: "Affiliate Partner — StartupWeekly",
      shortCode: "aff-sw",
      originalUrl: "https://mystore.com?aff=startupweekly",
      isActive: true,
      isPasswordProtected: false,
      isFavorite: false,
      expiresAt: null,
    ...
    {
      id: "dl-49",
      title: "YouTube Shorts CTA",
      shortCode: "yt-short",
      originalUrl: "https://mystore.com/trending?ref=yt-shorts",
      isActive: true,
      isPasswordProtected: false,
      isFavorite: false,
      expiresAt: null,
    ...
    },
    {
      ...
      shortCode: "b2s-24",
      originalUrl: "https://mystore.com/back-to-school-2024",
      isActive: true,
      isPasswordProtected: false,
      isFavorite: true,
  ...
  return [
    {
      ...
      name: "Summer Sale 2024",
      description:
        "All links for the summer sale campaign across social and email channels.",
      createdAt: daysAgo(50),
      _count: { links: DEMO_CAMPAIGN_LINKS["dc-01"].length },
    },
    {
      id: "dc-02",
      name: "Black Friday 2023",
      description:
        "Seasonal Black Friday and holiday sale links — now archived.",
      createdAt: daysAgo(220),
      _count: { links: DEMO_CAMPAIGN_LINKS["dc-02"].length },
    },
    {
      id: "dc-03",
      name: "Product Launch Q1",
      description: "Launch-day links: Product Hunt, paid ads, and LinkedIn.",
      createdAt: daysAgo(20),
      _count: { links: DEMO_CAMPAIGN_LINKS["dc-03"].length },
    },
    {
      id: "dc-04",
      name: "Newsletter Series",
      description: "CTA links embedded in every newsletter edition.",
      createdAt: daysAgo(130),
      _count: { links: DEMO_CAMPAIGN_LINKS["dc-04"].length },
    },
    {
      id: "dc-05",
      name: "Social Media Links",
      description: "Bio and story links across all social platforms.",
      createdAt: daysAgo(95),
      _count: { links: DEMO_CAMPAIGN_LINKS["dc-05"].length },
    },
    {
      id: "dc-06",
      name: "Podcast Episodes",
      description: "Sponsor codes and show-notes links for podcast episodes.",
      createdAt: daysAgo(45),
      _count: { links: DEMO_CAMPAIGN_LINKS["dc-06"].length },
    },
  ];
}
...
export function getDemoCampaignDetail(id: string) {
  ...
  const links = (DEMO_CAMPAIGN_LINKS[
    base.id as keyof typeof DEMO_CAMPAIGN_LINKS
  ] ?? DEMO_CAMPAIGN_LINKS["dc-01"]) as unknown as CampaignLinks;
  return {
    ...base,
...
export function getDemoAnalytics(days: number) {
  ...
  return {
    ...
    clicksByBrowser: [
      ...
      { browser: "Samsung Browser", count: Math.round(totalClicks * 0.1) },
    ...
    topCountries: [
      ...
      { country: "United Kingdom", count: Math.round(totalClicks * 0.1) },
    ...
    topLinks: [
      {
        ...
        shortCode: "summer24",
        count: Math.round(totalClicks * 0.24),
      },
      {
        id: "dl-02",
        label: "Google Ads — Brand Campaign",
        shortCode: "gads-br",
        count: Math.round(totalClicks * 0.16),
      },
      {
        id: "dl-03",
        label: "Email Signature Link",
        shortCode: "email-sig",
        count: Math.round(totalClicks * 0.12),
      },
      {
        id: "dl-04",
        label: "App Store Download — iOS",
        shortCode: "app-ios",
        count: Math.round(totalClicks * 0.1),
      },
      {
        id: "dl-05",
        label: "Affiliate Partner — TechBlog",
        shortCode: "aff-tb",
        count: Math.round(totalClicks * 0.08),
      },
      {
        id: "dl-11",
        label: "Google Ads — Retargeting",
        shortCode: "gads-retg",
        count: Math.round(totalClicks * 0.06),
      },
      {
        id: "dl-06",
        label: "YouTube Description CTA",
        shortCode: "yt-desc",
        count: Math.round(totalClicks * 0.05),
      },
      {
        id: "dl-07",
        label: "Twitter / X Profile Link",
        shortCode: "tw-bio",
        count: Math.round(totalClicks * 0.04),
      },
      {
        id: "dl-10",
        label: "Play Store Download",
        shortCode: "app-android",
        count: Math.round(totalClicks * 0.03),
      },
      {
        id: "dl-09",
        label: "LinkedIn Company Post",
        shortCode: "li-post",
        count: Math.round(totalClicks * 0.02),
      },
    ],
  };
}
...
const DEMO_PORTAL_CLIENTS: Record<
  string,
  {
    id: string;
    clientName: string;
    ...
    campaigns: [
      {
        campaign: {
          ...
          description:
            "All links for the summer sale campaign across social and email channels.",
          shareToken: "share-dc-01",
          links: DEMO_CAMPAIGN_LINKS["dc-01"].map((l) => ({
            id: l.id,
            isActive: l.isActive,
      ...
      },
      {
        campaign: {
          ...
          name: "Product Launch Q1",
          description:
            "Launch-day links: Product Hunt, paid ads, and LinkedIn.",
          shareToken: "share-dc-03",
          links: DEMO_CAMPAIGN_LINKS["dc-03"].map((l) => ({
            id: l.id,
            isActive: l.isActive,
            expiresAt: l.expiresAt,
            _count: { clicks: l._count.clicks },
    ...
    campaigns: [
      {
        campaign: {
          ...
          description: "Bio and story links across all social platforms.",
          shareToken: "share-dc-05",
          links: DEMO_CAMPAIGN_LINKS["dc-05"].map((l) => ({
            id: l.id,
            isActive: l.isActive,
            expiresAt: l.expiresAt,
            _count: { clicks: l._count.clicks },
    ...
    campaigns: [
      {
        campaign: {
          ...
          description:
            "Seasonal Black Friday and holiday sale links — now archived.",
          shareToken: "share-dc-02",
          links: DEMO_CAMPAIGN_LINKS["dc-02"].map((l) => ({
            id: l.id,
            isActive: l.isActive,
            expiresAt: l.expiresAt,
            _count: { clicks: l._count.clicks },
      ...
      },
      {
        campaign: {
          ...
          description: "CTA links embedded in every newsletter edition.",
          shareToken: "share-dc-04",
          links: DEMO_CAMPAIGN_LINKS["dc-04"].map((l) => ({
            id: l.id,
            isActive: l.isActive,
            expiresAt: l.expiresAt,
            _count: { clicks: l._count.clicks },
      ...
      },
      {
        campaign: {
          ...
          name: "Podcast Episodes",
          description:
            "Sponsor codes and show-notes links for podcast episodes.",
          shareToken: "share-dc-06",
          links: DEMO_CAMPAIGN_LINKS["dc-06"].map((l) => ({
            id: l.id,
            isActive: l.isActive,
            expiresAt: l.expiresAt,
            _count: { clicks: l._count.clicks },
...
export function getDemoReportData(shareToken: string) {
  ...
  return {
    ...
    links: (
      (
        DEMO_CAMPAIGN_LINKS as Record<
          string,
          (typeof DEMO_CAMPAIGN_LINKS)[keyof typeof DEMO_CAMPAIGN_LINKS]
        >
      )[id] ?? []
    ).map((l) => ({
      id: l.id,
