...
export function FeatureCard({
  ...
  return (
    <Card className="group border-slate-200/80 bg-white/90 shadow-sm transition duration-300 hover:-translate-y-1.5 hover:border-primary/20 hover:shadow-xl hover:shadow-slate-200/70">
