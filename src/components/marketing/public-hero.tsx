  ...
  return (
    <section className="relative overflow-hidden border-b border-slate-200 bg-slate-50">
      <div className="absolute inset-0 -z-10">
        <div className="absolute left-[-8%] top-[-18%] h-[500px] w-[500px] rounded-full bg-primary/20/35 blur-3xl" />
        <div className="absolute right-[-10%] top-[5%] h-[420px] w-[420px] rounded-full bg-blue-200/30 blur-3xl" />
        <div className="absolute bottom-[-20%] left-[35%] h-[380px] w-[380px] rounded-full bg-emerald-100/45 blur-3xl" />
      </div>
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 py-16 sm:px-6 lg:grid-cols-[1fr_0.9fr] lg:gap-16 lg:px-8 lg:py-20">
        ...
        <div>
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-primary/20 bg-white/80 px-4 py-2 text-sm font-semibold text-primary shadow-sm backdrop-blur">
        ...
        <div className="relative">
          <div className="absolute -inset-4 rounded-[2rem] bg-gradient-to-br from-primary/20/30 via-white/60 to-blue-200/40 blur-xl" />
          <div className="relative">
            <GuestLinkForm />
          </div>
        </div>
